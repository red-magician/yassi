...
.upload-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:14px;margin:16px 0}
.upload-grid .slot{min-width:0;border:1.5px dashed var(--line);border-radius:10px;padding:16px;text-align:center;font-size:12.5px}
.upload-grid .slot.done{border-color:var(--ok);background:#eafaf1}
.upload-grid .slot input{display:block;width:100%;margin:10px auto 0}
"""
